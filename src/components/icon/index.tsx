...
export const getIcon = (props: IconProps | IconType): React.ReactNode => {
  ...
  switch (iconType) {
    ...
    case 'settings': return (
      <svg className={className + ' mr'} fill={fill} stroke="currentColor" viewBox="0 0 24 24">
    ...
    case 'pioneer-recognition': return (
      <svg className={className} fill={fill} stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
      </svg>
    )
    case 'first-access': return (
      <svg className={className} fill={fill} stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1" />
      </svg>
    )
    case 'influence-platform': return (
      <svg className={className} fill={fill} stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
      </svg>
    )
    case 'early-visibility': return (
      <svg className={className} fill={fill} stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 18.657A8 8 0 016.343 7.343S7 9 9 10c0-2 .5-5 2.986-7C14 5 16.09 5.777 17.656 7.343A7.975 7.975 0 0120 13a7.975 7.975 0 01-2.343 5.657z" />
      </svg>
    )
    case 'ten-pm-ten-min': return (
      <svg className={className} fill={fill} stroke="currentColor" viewBox="0 0 24 24">
    ...
    case 'better-features': return (
      <svg className={className} fill={fill} stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
      </svg>
    )
    case 'new-project': return (
    ...
    case 'success': return (
      <svg className={`${className} text-green-600 dark:text-green-600`} fill={fill} stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
      </svg>
    )
    case 'arrow': return (
      <svg className={className} width="20" height="10" viewBox="0 0 20 10" fill={fill}>
        <path
    ...
    case 'arrow-right-down': return (
      <svg className={className} fill={fill} stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 12L15 12M15 12L15 18M13 16L15 18L17 16" />
      </svg>
    )
    case 'check': return (
      <svg className={`text-green ${className}`} fill={fill} stroke="currentColor" viewBox="0 0 24 24">
    ...
    case 'influencer-history': return (
      <svg className={className} fill="currentColor" viewBox="0 0 24 24">
        <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
      </svg>
    )
    case 'influencer-work': return (
      <svg className={className} fill="currentColor" viewBox="0 0 24 24">
        <path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
      </svg>
    )
    ...
    case 'cascading-balance': return (
      <svg className={className} fill="currentColor" viewBox="0 0 24 24">
        <path d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z" />
      </svg>
    )
    case 'project-info': return (
      <svg className={className} fill="currentColor" viewBox="0 0 24 24">
    ...
    case 'cascading-work': return (
      <svg className={className} fill="currentColor" viewBox="0 0 24 24">
        <path d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z" />
      </svg>
    )
    case 'bluesky': return (
      <svg className={className} fill={"currentColor"} stroke="currentColor" viewBox="0 0 600 530" preserveAspectRatio="xMidYMid meet">
    ...
    case 'arrow-to-br-corner': return (
      <svg className={className} fill={fill} stroke="currentColor" viewBox="0 0 24 24">
    ...
    default:
      return (
        <svg className={`${className} text-purple-600`} fill="currentColor" viewBox="0 0 20 20">
...
export const DashboardIcon: React.FC<{ className?: string;[key: string]: any }> = ({ className = '', ...props }) => (
  <svg
    className={className}
    fill="currentColor"
    viewBox="0 0 24 24"
...
// Star Icon
export const StarIcon: React.FC<{ className?: string;[key: string]: any }> = ({ className = '', ...props }) => (
  <svg
    className={className}
    fill="currentColor"
    viewBox="0 0 24 24"
